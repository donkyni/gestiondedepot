...
!function(){
	...
	var n=/(cent|mille|(m|b|tr|quadr)illion)$/,
	r=/teen$/,
	o=/y$/,
	i=/(zéro|un|deux|trois|quatre|cinq|six|sept|huit|neuf|dix|onze|douze)$/,
...
c=1e15,
g=9007199254740992,
m=["zéro","un","deux","trois","quatre","cinq","six","sept","huit","neuf","dix","onze","douze","treize","quatorze","quinze","seize","dix-sept","dix-huit","dix-neuf"],
w=["zéro","dix","vingt","trente","quarante","cinquante","soixante","soixante-dix","quatre-vingt","quatre-vingt-dix"];
function x(e,t){
	var n,
	r=parseInt(e,10);
	...
	return n=function e(t){
		...
		t<20?(n=0,r=m[t]):t<d?(n=t%u,r=w[Math.floor(t/u)],n&&(r+="-"+m[n],n=0)):t<p?(n=t%d,r=e(Math.floor(t/d))+" cent"):t<v?(n=t%p,r=e(Math.floor(t/p))+" mille,"):t<b?(n=t%v,r=e(Math.floor(t/v))+" million,"):t<y?(n=t%b,r=e(Math.floor(t/b))+" billion,"):t<c?(n=t%y,r=e(Math.floor(t/y))+" trillion,"):t<=g&&(n=t%c,r=e(Math.floor(t/c))+" quadrillion,");
		o.push(r);
		return e(n,o)
	}
	(r),t?h(n):n
